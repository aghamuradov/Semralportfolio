...
if (contactForm) {
    contactForm.addEventListener('submit', (e) => {
        ...
        alert('Ihr E-Mail-Programm wird geöffnet. Bitte senden Sie die Nachricht ab.');
...
console.log('%c👋 Hallo! Schön, dass Sie sich den Code ansehen!', 'color: #2563eb; font-size: 16px; font-weight: bold;');
console.log('%c🚀 Dieses Portfolio wurde mit modernen Web-Technologien erstellt.', 'color: #6b7280; font-size: 14px;');
console.log('%c📧 Kontakt: abdurahmanov.semral@gmail.com', 'color: #10b981; font-size: 14px;');
console.log('%c✨ Viel Spaß beim Erkunden!', 'color: #f093fb; font-size: 14px; font-weight: bold;');
